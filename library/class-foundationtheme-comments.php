<?php
/**
 * FoundationTheme Comments
 *
 * @package FoundationTheme
 */

if ( ! class_exists( 'Foundationtheme_Comments' ) ) :
class Foundationtheme_Comments extends Walker_Comment {
	...
	function __construct() { ?>
		...
		<h3><?php comments_number( __( 'No Responses to', 'foundationtheme' ), __( 'One Response to', 'foundationtheme' ), __( '% Responses to', 'foundationtheme' ) ); ?> &#8220;<?php the_title(); ?>&#8221;</h3>
	...
	function start_el( &$output, $comment, $depth = 0, $args = array(), $id = 0 ) {
		...
		<header class="comment-author">
			...
			<?php
				...
				printf( __(
					'<cite class="fn">%s</cite>', 'foundationtheme' ),
