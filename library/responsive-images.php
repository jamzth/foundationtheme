...
function foundationtheme_custom_sizes( $sizes ) {
...
add_filter( 'image_size_names_choose', 'foundationtheme_custom_sizes' );

// Add custom image sizes attribute to enhance responsive image functionality for content images
function foundationtheme_adjust_image_sizes_attr( $sizes, $size ) {
...
add_filter( 'wp_calculate_image_sizes', 'foundationtheme_adjust_image_sizes_attr', 10 , 2 );
