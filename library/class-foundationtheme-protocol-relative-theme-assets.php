 ...
 * @since FoundationTheme 1.1.0
 */

if ( ! class_exists( 'Foundationtheme_Protocol_Relative_Theme_Assets' ) ) :
	class Foundationtheme_Protocol_Relative_Theme_Assets {
		/**
	...
	$foundationtheme_protocol_relative_theme_assets = new Foundationtheme_Protocol_Relative_Theme_Assets;
endif;
